...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('Esta é a sua página de perfil. Você pode ver e gerenciar seu perfil'),
        'class' => 'col-lg-7'
    ])   
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                                    <div>
                                        <span class="heading">{{$quantUsuarios}}</span>
                                        <span class="description">{{ __('Usuários') }}</span>
                                    </div>
                                    <div>
                                        <span class="heading">{{$quantEstacionamentos}}</span>
                                        <span class="description">{{ __('Estacionamentos') }}</span>
                                    </div>
                                    <div>
                                        <span class="heading">{{$quantVeiculos}}</span>
                                        <span class="description">{{ __('Veículos') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
